...
<body>
    <nav class="w-screen flex justify-between border-box py-4 px-10 bg-blue-800 text-white items-center">
        <h1>Admin</h1>
        <ul class="flex gap-5">
            <a href="index.php" class="cursor-pointer hover:bg-blue-400 hover:text-black h-full p-2">daftarkan Amil</a>
